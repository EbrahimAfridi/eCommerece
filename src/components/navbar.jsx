...
import {MagnifyingGlass, ShoppingBag, ShoppingCart, Storefront, User, X} from "phosphor-react";
  ...
  return (
    <div className="navbar">
      ...
      <div className="mr-3 links sm:mr-6">
        <MagnifyingGlass onClick={handleSearchIconClick} color='#f1efef' size={25} />
        <Link to='/account'>
