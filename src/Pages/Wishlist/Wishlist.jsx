...
export const Wishlist = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="px-8 wishlist text-center">
        <h1 className="heading-h1 text-4xl">Wishlist</h1>
      ...
      <div className="w-64 m-auto mt-4 flex justify-center">
        <button
          //   className="p-2 md:ml-10 text-lg text-white bg-black rounded-md"
          className="rounded-md text-xs sm:text-lg outline-none bg-black text-white shadow-sm border p-2 tracking-wider hover:opacity-70"
