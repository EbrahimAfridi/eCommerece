    ...
    <div className="shop">
      ...
      <div className="relative">
        ...
        <div className="chooseUs">
          ...
          <div className="icons">
            <div className="icon">
              <img src="https://neemans.com/cdn/shop/files/PerfectFit_eba3f4ea-15fb-4af6-9b06-d34bd5790cc4.svg?v=1688997442" alt="" />
              <h4>COMFORTABLE</h4>
            </div>
            <div className="icon">
              <img src="https://neemans.com/cdn/shop/files/EasyToStyle_ac7ac370-8a7a-4df3-9fef-ff5f6b1af077.svg?v=1688997442" alt="" />
              <h4>EASY TO STYLE</h4>
            </div>
            <div className="icon">
              <img src="https://neemans.com/cdn/shop/files/Sustainable_5389836c-e054-4ef6-aa90-291f2a38af64.svg?v=1688997442" alt="" />
              <h4>SUSTAINABLE</h4>
            </div>
            <div className="icon">
              <img src="https://neemans.com/cdn/shop/files/EverydayWear_9a51f1da-a8a5-4712-ba7f-0b2c3cb010d1.svg?v=1688997442" alt="" />
              <h4>EVERYDAY WEAR</h4>
            </div>
          </div>
        </div>
