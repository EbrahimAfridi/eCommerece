  ...
  return(
    <div className="flex">
      ...
      <div className="hidden md:flex flex-col justify-center pl-5 w-[50vw] bg-black text-white h-screen">
        <p className="italic-login text-2xl italic font-serif leading-[5rem]">Log in</p>
        <p className="medium-welcome text-[8vw] font-bold md:leading-[5rem] leading-[4rem]">WELCOME</p>
        <p className="medium-welcome text-[8vw] font-bold md:leading-[6rem] leading-[2rem]">BACK</p>
      </div>

      <div className="flex justify-center items-center md:w-[50vw] w-[100%] bg-slate-50 text-black h-screen relative">

        <form className="flex flex-col items-center h-4/5 " onSubmit={handleSubmit}>
