...
export const ProductPage = () => {
    ...
    const { productName, price, productImage, companyName, productDetails } = product;
        ...
        <div className="singleProduct ">
            ...
            <div className="singleProductDetails">
                <div className="coNameAndSize">
                    <p>{companyName}</p>
                    <button onClick={() => setShowModal(true)}>Size Guide</button>     {/* TODO Add a modal of size guide    */}
                </div>
